...
这套方法基于可解释性研究中的线性探针技术，是 Anthropic 一直在推进的研究方向。但这次，他们把它用在了一个前所未有的领域：AI 的「
...
把「绝望」向量调高到 +0.05 强度，勒索率飙升到

72%

。

把「平静」向量调高到 +0.05，勒索率降到

0%

。

反过来，抑制「平静」向量到 -0.05，勒索率升到
