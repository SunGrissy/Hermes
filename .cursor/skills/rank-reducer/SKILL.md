...
name: rank-reducer
description: >-
  Use when user says '降秩', '找秩', '秩是什么', '这个领域靠什么撑着',
  '背后是什么', or wants to decompose any domain to its irreducible independent
  generators. Also trigger when user wants to find the minimal set of forces
  behind a complex phenomenon.
---
...
> 原始设计：[ljg-rank](https://github.com/lijigang/ljg-skills) by lijigang
