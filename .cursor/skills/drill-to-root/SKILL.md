...
name: drill-to-root
description: >-
  Use when user says '想透', '追本', '本质是什么', '为什么会这样', '深挖',
  '钻到底', 'think deep', 'drill down', or wants to trace any idea or
  phenomenon vertically to its irreducible root. Also trigger when user
  provides a statement and wants depth analysis, not breadth survey.
---

## Usage

```
User: 追本：为什么大公司总是创新乏力？
Assistant: [一路向下钻到不可再分的本质]
```
...
> 原始设计：[ljg-think](https://github.com/lijigang/ljg-skills) by lijigang
